...
public final class LetterBag {
    ...
    static {
        letterScoreMappings.put('a', 1);
        letterScoreMappings.put('b', 3);
        letterScoreMappings.put('c', 3);
        letterScoreMappings.put('d', 2);
        letterScoreMappings.put('e', 1);
        letterScoreMappings.put('f', 4);
        letterScoreMappings.put('g', 2);
        letterScoreMappings.put('h', 4);
        letterScoreMappings.put('i', 1);
        letterScoreMappings.put('j', 8);
        letterScoreMappings.put('k', 5);
        letterScoreMappings.put('l', 1);
        letterScoreMappings.put('m', 3);
        letterScoreMappings.put('n', 1);
        letterScoreMappings.put('o', 1);
        letterScoreMappings.put('p', 3);
        letterScoreMappings.put('q', 10);
        letterScoreMappings.put('r', 1);
        letterScoreMappings.put('s', 1);
        letterScoreMappings.put('t', 1);
        letterScoreMappings.put('u', 1);
        letterScoreMappings.put('v', 4);
        letterScoreMappings.put('w', 4);
        letterScoreMappings.put('x', 8);
        letterScoreMappings.put('y', 4);
        letterScoreMappings.put('z', 10);
        letterScoreMappings.put('A', 1);
        letterScoreMappings.put('B', 3);
        letterScoreMappings.put('C', 3);
        letterScoreMappings.put('D', 2);
    ...
    // need to figure out if the bag is empty
