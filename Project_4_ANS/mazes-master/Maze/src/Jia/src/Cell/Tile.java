...
public class Tile extends Observable
{
    ...
    public Tile(int x, int y, int size)
    {
        ...
        typeMap.put(Type.END, Color.PURPLE);
        ...
        int[] WEIGHTS = {this.getDefaultWeight(), 3, 6, 9, 12};
        visitedMap.put(WEIGHTS[0], Color.PALEGREEN);
        visitedMap.put(WEIGHTS[1], Color.LIGHTGREEN);
        visitedMap.put(WEIGHTS[2], Color.SPRINGGREEN);
        visitedMap.put(WEIGHTS[3], Color.GREENYELLOW);
        visitedMap.put(WEIGHTS[4], Color.GREEN);
        
        // Empty Weight color 
        weightMap = new HashMap<>();
        weightMap.put(WEIGHTS[0], Color.WHITE);
        weightMap.put(WEIGHTS[1], Color.LIGHTCYAN);
        weightMap.put(WEIGHTS[2], Color.AQUA);
        weightMap.put(WEIGHTS[3], Color.DEEPSKYBLUE);
        weightMap.put(WEIGHTS[4], Color.CORNFLOWERBLUE);
