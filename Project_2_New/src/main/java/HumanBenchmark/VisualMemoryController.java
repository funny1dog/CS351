...
public class VisualMemoryController extends MiniGame {
    ...
    public VisualMemoryController(/*String n, String unit, boolean inverse*/) throws Exception {
    ...
    public void setUpCanvas (int lvl){
        ...
        for (int i = 0; i < lvl; i++) {
            ...
            pause.setOnFinished(e -> {
                ...
                newButtons.get(finalI).setStyle(null);
            });
            pause.play();
        }
    ...
    public void match (){
        ...
        if (totalMouseClick==1 && lvl==1){
            ...
            if (userButtons.containsAll(newButtons) && newButtons.containsAll(userButtons)) {
